...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(num_rolls):
        ...
        if not is_slow_sad:
            count += sided_num
    return 1 if is_slow_sad else count
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    second_rightmost_digit = opponent_score // 10 % 10
    player_score = 3 * abs(second_rightmost_digit - rightmost_digit)

    return 1 if player_score == 0 else player_score
    # END PROBLEM 2
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    # BEGIN PROBLEM 5
    max_score = 0
    while max_score < goal:
        if who == 0:
            score0 = update(strategy0(score0, score1), score0, score1, dice)  # player0
        else:
            score1 = update(strategy1(score1, score0), score1, score0, dice)  # player1
